    ...
    return [
      {
        ...
        apy: subnetData['subnet-1']?.totalStake > 0 ? ((subnetData['subnet-1'].totalRewards / subnetData['subnet-1'].totalStake) * 100).toFixed(1) : 50.0,
      ...
      },
      {
        ...
        apy: subnetData['subnet-2']?.totalStake > 0 ? ((subnetData['subnet-2'].totalRewards / subnetData['subnet-2'].totalStake) * 100).toFixed(1) : 50.0,
      ...
      },
      {
        ...
        apy: subnetData['subnet-3']?.totalStake > 0 ? ((subnetData['subnet-3'].totalRewards / subnetData['subnet-3'].totalStake) * 100).toFixed(1) : 50.0,
      ...
      },
      {
        ...
        apy: subnetData['subnet-4']?.totalStake > 0 ? ((subnetData['subnet-4'].totalRewards / subnetData['subnet-4'].totalStake) * 100).toFixed(1) : 50.0,
      ...
      },
      {
        ...
        apy: subnetData['subnet-5']?.totalStake > 0 ? ((subnetData['subnet-5'].totalRewards / subnetData['subnet-5'].totalStake) * 100).toFixed(1) : 50.0,
      ...
      },
      {
        ...
        apy: subnetData['subnet-6']?.totalStake > 0 ? ((subnetData['subnet-6'].totalRewards / subnetData['subnet-6'].totalStake) * 100).toFixed(1) : 50.0,
